...
const ActualizarProducto = () => {
    ...
    const { category, size, description, availability, price, quantity, photography } = productosActualizar;
    ...
    return( 
      ...
      <h1 className="text-3xl font-light mb-4 text-center">Actualizar Productos</h1>
...
<div className="flex justify-center mt-10">
     <div className="w-full max-w-3xl">
         ...
         > 
             ...
             <div className="mb-4">
                 <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="nombre">TAMAÑO :</label>
                 <input 
                     className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                     id="size"
                     type="text"
